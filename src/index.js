      ...
      {numPizzas > 0 ? (
        <>
          <p>
            ...
            our stoned oven,all organic,all delicious.
          </p>
...
const Footer = () => {
  ...
  const isOpen = hours >= openHour && hours <= closingHour;
  console.log(isOpen);
...
const Order = ({ closingHour }) => {
  return (
    <p>
      We are open until {closingHour}:00 hours.Come visit us or order online
    </p>
  );
};
